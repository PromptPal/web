...
import { ArrowRight, Mail, Shield, Sparkles, Wallet } from 'lucide-react'
...
function AuthorizePage() {
  ...
  const [activeTab, setActiveTab] = useState<'email' | 'sso'>('sso')
        ...
        <div className='relative'>
          ...
          <div className='relative bg-gradient-to-br from-gray-900/90 to-gray-800/90 backdrop-blur-xl border border-gray-700/50 rounded-3xl shadow-2xl p-8 space-y-8'>
            ...
            <motion.div
              ...
              className='flex rounded-lg bg-gray-800/50 p-1'
            >
              <button
                onClick={() => setActiveTab('email')}
                className={cn(
                  'flex-1 flex items-center justify-center gap-2 px-4 py-2 rounded-md font-medium text-sm transition-all duration-200',
                  activeTab === 'email'
              ...
              <div className='flex items-center justify-center gap-2 text-sm text-gray-400'>
                ...
                <span>
                  {activeTab === 'email'
                    ...
                    : 'Secure authentication powered by blockchain'}
                </span>
              </div>
            </motion.div>
          </div>
