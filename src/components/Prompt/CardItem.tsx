...
function PromptCardItem(props: PromptCardItemProps) {
  ...
  return (
    <Link
      ...
      className='group w-full p-6 rounded-xl flex flex-col gap-4 bg-gradient-to-br from-gray-900/60 via-gray-800/40 to-gray-900/60 backdrop-blur-xl shadow-xl transition-all duration-300 hover:shadow-2xl hover:shadow-blue-500/20 hover:from-gray-900/70 hover:via-gray-800/50 hover:to-gray-900/70'
    >
      <div className='flex items-center gap-3'>
        <div className='p-2.5 rounded-lg bg-gradient-to-br from-blue-500/20 via-purple-500/10 to-blue-500/5 backdrop-blur-xl text-blue-400'>
      ...
      <div className='flex flex-wrap gap-3 text-sm'>
        <div
          className={cn(
            ...
            prompt.tokenCount < 300
              ? 'bg-gradient-to-r from-green-500/20 to-green-500/10 text-green-400'
              : 'bg-gradient-to-r from-red-500/20 to-red-500/10 text-red-400',
          )}
        >
        ...
        <div className='flex items-center gap-1.5 px-3 py-1 rounded-full font-medium bg-gradient-to-r from-blue-500/20 to-purple-500/10 text-blue-400 backdrop-blur-xl'>
